import { View, RefreshControl, Text, Image, Divider, StyleSheet } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <InputField placeholder="Buscar perfil..." style={styles.inputBuscar} onChangeText={
                    (text) => {
                        setNameFilter(text);
                        ...
                        <>
                            <View style={styles.profile1}>
                                ...
                                <View style={styles.profileInfo}>
                                    ...
                                    <Text style={styles.profilePoints}>{user.user_points} pontos</Text>
                                </View>
                            </View>
